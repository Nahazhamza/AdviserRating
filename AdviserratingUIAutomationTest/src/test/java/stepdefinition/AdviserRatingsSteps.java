...
public void selectLocationFeild(String Expectedlocation) throws InterruptedException, WebDriverInstanceNullException, InvalidInputException, ResourceCustomException, IOException {
	try{
		Thread.sleep(2000);
